...
#define SpaceStart_TargetStatic 0x28000000U
...
#define YELLOW_ZONE_HIT LISPOBJ(0x280000E7)
#define RED_ZONE_HIT LISPOBJ(0x280000FF)
#define DYNAMIC_SPACE_OVERFLOW_WARNING_HIT LISPOBJ(0x28000117)
#define DYNAMIC_SPACE_OVERFLOW_ERROR_HIT LISPOBJ(0x2800012F)
#define HANDLE_BREAKPOINT LISPOBJ(0x28000147)
#define FDEFINITION_OBJECT LISPOBJ(0x2800015F)
#define READ_ONLY_SPACE_FREE_POINTER LISPOBJ(0x28000177)
#define STATIC_SPACE_FREE_POINTER LISPOBJ(0x2800018F)
#define INITIAL_DYNAMIC_SPACE_FREE_POINTER LISPOBJ(0x280001A7)
#define CURRENT_CATCH_BLOCK LISPOBJ(0x280001BF)
#define CURRENT_UNWIND_PROTECT_BLOCK LISPOBJ(0x280001D7)
#define EVAL_STACK_TOP LISPOBJ(0x280001EF)
#define ALIEN_STACK LISPOBJ(0x28000207)
#define PSEUDO_ATOMIC_ATOMIC LISPOBJ(0x2800021F)
#define PSEUDO_ATOMIC_INTERRUPTED LISPOBJ(0x28000237)
#define INTERRUPTS_ENABLED LISPOBJ(0x2800024F)
#define INTERRUPT_PENDING LISPOBJ(0x28000267)
#define FREE_INTERRUPT_CONTEXT_INDEX LISPOBJ(0x2800027F)
#define ALLOCATION_POINTER LISPOBJ(0x28000297)
#define BINDING_STACK_POINTER LISPOBJ(0x280002AF)
#define INTERNAL_GC_TRIGGER LISPOBJ(0x280002C7)
#define FP_CONSTANT_0D0 LISPOBJ(0x280002DF)
#define FP_CONSTANT_1D0 LISPOBJ(0x280002F7)
#define FP_CONSTANT_0S0 LISPOBJ(0x2800030F)
#define FP_CONSTANT_1S0 LISPOBJ(0x28000327)
#define FP_CONSTANT_0L0 LISPOBJ(0x2800033F)
#define FP_CONSTANT_1L0 LISPOBJ(0x28000357)
#define FP_CONSTANT_PI LISPOBJ(0x2800036F)
#define FP_CONSTANT_L2T LISPOBJ(0x28000387)
#define FP_CONSTANT_L2E LISPOBJ(0x2800039F)
#define FP_CONSTANT_LG2 LISPOBJ(0x280003B7)
#define FP_CONSTANT_LN2 LISPOBJ(0x280003CF)
#define SCAVENGE_READ_ONLY_SPACE LISPOBJ(0x280003E7)
#define CONTROL_STACKS LISPOBJ(0x280003FF)
#define SLOT_UNBOUND LISPOBJ(0x28000417)
#define X86_CGC_ACTIVE_P LISPOBJ(0x2800042F)
#define LINKAGE_TABLE_DATA LISPOBJ(0x28000447)
#define GLOBAL_TABLE LISPOBJ(0x2800045F)
#define CURRENT_REGION_FREE_POINTER LISPOBJ(0x28000477)
#define CURRENT_REGION_END_ADDR LISPOBJ(0x2800048F)
#define CMUCL_LIB LISPOBJ(0x280004A7)
#define CMUCL_CORE_PATH LISPOBJ(0x280004BF)
#define KEY LISPOBJ(0x280004D7)
#define VALUE LISPOBJ(0x280004EF)
#define KEY_AND_VALUE LISPOBJ(0x28000507)
#define KEY_OR_VALUE LISPOBJ(0x2800051F)
#define UNIDATA_PATH LISPOBJ(0x28000537)
#define SPARE_9 LISPOBJ(0x2800054F)
#define SPARE_8 LISPOBJ(0x28000567)
#define SPARE_7 LISPOBJ(0x2800057F)
#define SPARE_6 LISPOBJ(0x28000597)
#define SPARE_5 LISPOBJ(0x280005AF)
#define SPARE_4 LISPOBJ(0x280005C7)
#define SPARE_3 LISPOBJ(0x280005DF)
#define SPARE_2 LISPOBJ(0x280005F7)
#define SPARE_1 LISPOBJ(0x2800060F)
#define STATIC_BLUE_BAG LISPOBJ(0x28000627)

/* Runtime features when built. */

#define FEATURE_MP 1
#define FEATURE_LINKAGE_TABLE 1
#define FEATURE_EXECUTABLE 1
#define FEATURE_MACH_O 1
#define FEATURE_GENCGC 1
#define FEATURE_UNICODE 1
